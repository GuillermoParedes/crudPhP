/**
 * Created by Guillermo David on 13/07/2015.
 */
$(function()
{
...
function renderUserList(jsonData)
{
    ...
    $.each( jsonData, function( index, user){
        ...
        table += '<td><a href="javascript:void(0);" user_id="'+user.id+'" class="delete_confirm btn btn-danger"><i class="glyphicon glyphicon-remove glyphicon-white"></i></a></td>';
        table += '</tr>';
    });
    table += '</tbody></table>';
...
function getCreateForm(element)
{
    ...
    form +=	'<span class="add-on"><i class="glyphicon glyphicon-user glyphicon-black"></i> Name</span>';
